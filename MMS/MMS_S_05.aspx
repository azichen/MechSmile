<%@ Page Language="VB" AutoEventWireup="false" CodeFile="MMS_S_05.aspx.vb" Inherits="MMS_MMS_S_05" %>
        ...
        <table style="width: 800px;">
            <tr>
                <td align="center" valign="bottom">
                     <asp:Label ID="lblTitle" runat="server" CssClass="titles" Text="未開發票預估收入查詢"></asp:Label>
                </td>
            </tr>
            <tr>
                <td class="style14">
                      ...
                      <table style="width: 800px;">
                          <tr>
                              ...
                              <td align="right" class="style24">
                                  ...
                                  發票截止日：</td>
                              <td align="left">
                                  &nbsp;<asp:TextBox ID="txtDtFrom0" runat="server" Width="100px"></asp:TextBox>
                                  <img src="../Images/date.gif" alt="按此可點選日期" style="border:0;" 
                            onclick="ShowCalendar('txtDtFrom0',true,false)" />
                              </td>
                          </tr>
                          <tr>
                ...
                <tr>
                    <td align="left">
                        ...
                        <asp:SqlDataSource ID="item_defList" runat="server"
                            ConnectionString="Data Source=127.0.0.1;Initial Catalog=smile_HQ;Persist Security Info=True;User ID=sa;Password=vispark;timeout=300"></asp:SqlDataSource>
                    </td>
                </tr>
            </table>
         </ContentTemplate>
