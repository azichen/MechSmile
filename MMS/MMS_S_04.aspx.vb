...
Partial Class MMS_MMS_S_04
    ...
    Protected Sub Page_Load(sender As Object, e As System.EventArgs) Handles Me.Load
        If Not IsPostBack Then
            ...
            modDB.SetFields("元月", "一月應入", grdList, HorizontalAlign.Left, "", False)
            modDB.SetFields("發票1", "發票1", grdList, HorizontalAlign.Left, "", False)
            modDB.SetFields("已入1", "已入1", grdList, HorizontalAlign.Left, "", False)
            modDB.SetFields("二月", "二月應入", grdList, HorizontalAlign.Left, "", False)
            modDB.SetFields("發票2", "發票2", grdList, HorizontalAlign.Left, "", False)
            modDB.SetFields("已入2", "已入2", grdList, HorizontalAlign.Left, "", False)
            modDB.SetFields("三月", "三月應入", grdList, HorizontalAlign.Left, "", False)
            modDB.SetFields("發票3", "發票3", grdList, HorizontalAlign.Left, "", False)
            modDB.SetFields("已入3", "已入3", grdList, HorizontalAlign.Left, "", False)
            modDB.SetFields("四月", "四月應入", grdList, HorizontalAlign.Left, "", False)
            modDB.SetFields("發票4", "發票4", grdList, HorizontalAlign.Left, "", False)
            modDB.SetFields("已入4", "已入4", grdList, HorizontalAlign.Left, "", False)
            modDB.SetFields("五月", "五月應入", grdList, HorizontalAlign.Left, "", False)
            modDB.SetFields("發票5", "發票5", grdList, HorizontalAlign.Left, "", False)
            modDB.SetFields("已入5", "已入5", grdList, HorizontalAlign.Left, "", False)
            modDB.SetFields("六月", "六月應入", grdList, HorizontalAlign.Left, "", False)
            modDB.SetFields("發票6", "發票6", grdList, HorizontalAlign.Left, "", False)
            modDB.SetFields("已入6", "已入6", grdList, HorizontalAlign.Left, "", False)
            modDB.SetFields("七月", "七月應入", grdList, HorizontalAlign.Left, "", False)
            modDB.SetFields("發票7", "發票7", grdList, HorizontalAlign.Left, "", False)
            modDB.SetFields("已入7", "已入7", grdList, HorizontalAlign.Left, "", False)
            modDB.SetFields("八月", "八月應入", grdList, HorizontalAlign.Left, "", False)
            modDB.SetFields("發票8", "發票8", grdList, HorizontalAlign.Left, "", False)
            modDB.SetFields("已入8", "已入8", grdList, HorizontalAlign.Left, "", False)
            modDB.SetFields("九月", "九月應入", grdList, HorizontalAlign.Left, "", False)
            modDB.SetFields("發票9", "發票9", grdList, HorizontalAlign.Left, "", False)
            modDB.SetFields("已入9", "已入9", grdList, HorizontalAlign.Left, "", False)
            modDB.SetFields("十月", "十月應入", grdList, HorizontalAlign.Left, "", False)
            modDB.SetFields("發票10", "發票10", grdList, HorizontalAlign.Left, "", False)
            modDB.SetFields("已入10", "已入10", grdList, HorizontalAlign.Left, "", False)
            modDB.SetFields("十一月", "11月應入", grdList, HorizontalAlign.Left, "", False)
            modDB.SetFields("發票11", "發票11", grdList, HorizontalAlign.Left, "", False)
            modDB.SetFields("已入11", "已入11", grdList, HorizontalAlign.Left, "", False)
            modDB.SetFields("十二月", "12月應入", grdList, HorizontalAlign.Left, "", False)
            modDB.SetFields("發票12", "發票12", grdList, HorizontalAlign.Left, "", False)
            modDB.SetFields("已入12", "已入12", grdList, HorizontalAlign.Left, "", False)
            '--------------------------------------------------* 加入連結欄位
            Me.grdList.RowStyle.Height = 18

            Call modDB.ShowEmptyDataGridHeader(Me.grdList, 0, 45, Me.ViewState("EmptyTable"))
    ...
    Protected Sub ExcelButton_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles ExcelButton.Click
        ...
        grdList.DataBind()
        modUtil.GridView2Excel("MMS_S_04.xls", Me.grdList)
    ...
    Private Sub ShowGrid()
        ...
        End If
        '20140718 增加發票日期過濾
        If Me.txtDtFrom.Text <> "" Then '發票截止日 '20141007
...
#End Region
    ...
    Protected Sub CheckBox2_CheckedChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles CheckBox2.CheckedChanged
        ...
        If (Areacode = "") And (Areacode = "F") Then 'modify in 20140911
            Me.DropDownList1.Enabled = Me.CheckBox2.Checked
        End If
        Me.DropDownList2.Enabled = Me.CheckBox2.Checked
    End Sub

    Protected Sub txtDtFrom1_TextChanged(ByVal sender As Object, ByVal e As System.EventArgs)
