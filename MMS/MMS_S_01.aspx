<%@ Page Language="VB" AutoEventWireup="false" CodeFile="MMS_S_01.aspx.vb" Inherits="MMS_MMS_S_01" %>
        ...
        <table style="width: 800px;">
            <tr>
                <td align="center" valign="bottom">
                     <asp:Label ID="lblTitle" runat="server" CssClass="titles" Text="保養案場合約明細查詢"></asp:Label>
                </td>
            </tr>
            <tr>
                <td class="style14">
                      ...
                      <table style="width: 800px;">
                          ...
                          <tr>
                              ...
                              <td align="right" class="style23">
                                  合約編號：</td>
                              <td>
                                  &nbsp;<asp:TextBox ID="txtDtFrom3" runat="server" AutoPostBack="True" Width="88px"></asp:TextBox>
                                  &nbsp;&nbsp;&nbsp;&nbsp;至 
                                  <asp:TextBox ID="txtDtFrom4" runat="server" Width="88px"></asp:TextBox>
                              </td>
                          </tr>
                          <tr>
                              <td align="right" class="style21">
                              ...
                              <td class="style23">
                                  &nbsp;</td>
                              <td>
                                  <asp:CheckBox ID="CheckBox3" runat="server" Text="未續約" />
                              </td>
                          </tr>
                          <tr>
