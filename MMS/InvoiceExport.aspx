<%@ Page Language="VB" AutoEventWireup="false" CodeFile="InvoiceExport.aspx.vb" Inherits="MMS_InvoiceExport" %>
        ...
        <table style="width: 800px;">
            <tr>
                <td align="center" valign="bottom">
                     <asp:Label ID="lblTitle" runat="server" CssClass="titles" Text="發票資料轉出"></asp:Label></td>
                </td>
            </tr>
            <tr>
                <td class="style14">
                  ...
                  <td align="left">
                      <table style="width: 800px;">
                          <tr>
                              ...
                              <td>
                                  申請日期： <asp:TextBox ID="txtDtFrom" runat="server" Width="88px"></asp:TextBox>
                          ...
                          <tr>
                              ...
                              <td>
                                  發票號碼： <asp:TextBox ID="txtDtFrom3" runat="server" AutoPostBack="True" 
                                      Width="88px"></asp:TextBox>
