<%@ Page Language="VB" AutoEventWireup="false" CodeFile="MMS_S_06.aspx.vb" Inherits="MMS_MMS_S_06" %>
        ...
        <table style="width: 800px;">
            <tr>
                <td align="center" valign="bottom">
                     <asp:Label ID="lblTitle" runat="server" CssClass="titles" Text="應開未開發票明細"></asp:Label></td>
                </td>
            </tr>
            <tr>
                <td class="style14">
