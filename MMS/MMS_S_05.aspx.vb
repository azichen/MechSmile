...
Partial Class MMS_MMS_S_05
    ...
    Protected Sub Page_Load(sender As Object, e As System.EventArgs) Handles Me.Load
        If Not IsPostBack Then
            ...
            modDB.SetFields("未開月份", "未開月份", grdList, HorizontalAlign.Left, "", False)
            modDB.SetFields("未開立金額", "未開立金額", grdList, HorizontalAlign.Left, "", False)
        ...
        modUtil.SetDateObj(Me.txtDtFrom0, False, Nothing, False)
    ...
    Protected Sub ExcelButton_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles ExcelButton.Click
        ...
        grdList.DataBind()
        modUtil.GridView2Excel("MMS_S_05.xls", Me.grdList)
    ...
    Private Sub ShowGrid()
        ...
        '--------------------------------------------------* 設定SqlDataSource連線及Select命令
        'Me.item_defList.ConnectionString = modDB.GetDataSource.ConnectionString
        Me.item_defList.ConnectionString = modUnset.HQ_GetDataSource_WithTimeout(300).ConnectionString
