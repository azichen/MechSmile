...
Partial Class MMS_MMS_S_02
    ...
    Private Sub ShowGrid()
        ...
        If RadioButtonList1.SelectedIndex = 0 Then
            modDB.SetFields("InvoiceNo", "發票號碼2", grdList, HorizontalAlign.Left, "", False)
            modDB.SetFields("發票日期", "發票日期2", grdList, HorizontalAlign.Left, "", False)
            modDB.SetFields("傳票日期", "傳票日期2", grdList, HorizontalAlign.Left, "", False)
            modDB.SetFields("發票區分", "發票區分2", grdList, HorizontalAlign.Left, "", False)
            modDB.SetFields("對象別", "對象別2", grdList, HorizontalAlign.Left, "", False)
            modDB.SetFields("客戶代號", "客戶代號2", grdList, HorizontalAlign.Left, "", False)

            Call modDB.ShowEmptyDataGridHeader(Me.grdList, 0, 5, Me.ViewState("EmptyTable"))
        ElseIf RadioButtonList1.SelectedIndex = 1 Then
            modDB.SetFields("InvoiceNo", "發票號碼5", grdList, HorizontalAlign.Left, "", False)
            modDB.SetFields("發票日期", "發票日期5", grdList, HorizontalAlign.Left, "", False)
            modDB.SetFields("傳票日期", "傳票日期5", grdList, HorizontalAlign.Left, "", False)
            modDB.SetFields("發票區分", "發票區分5", grdList, HorizontalAlign.Left, "", False)
            modDB.SetFields("對象別", "對象別5", grdList, HorizontalAlign.Left, "", False)
            modDB.SetFields("客戶代號", "客戶代號5", grdList, HorizontalAlign.Left, "", False)
            Call modDB.ShowEmptyDataGridHeader(Me.grdList, 0, 5, Me.ViewState("EmptyTable"))
        Else
            modDB.SetFields("InvoiceNo", "發票號碼3", grdList, HorizontalAlign.Left, "", False)
            modDB.SetFields("發票日期", "發票日期3", grdList, HorizontalAlign.Left, "", False)
            modDB.SetFields("傳票日期", "傳票日期3", grdList, HorizontalAlign.Left, "", False)
            modDB.SetFields("發票區分", "發票區分3", grdList, HorizontalAlign.Left, "", False)
            modDB.SetFields("對象別", "對象別3", grdList, HorizontalAlign.Left, "", False)
            modDB.SetFields("客戶代號", "客戶代號3", grdList, HorizontalAlign.Left, "", False)
            Call modDB.ShowEmptyDataGridHeader(Me.grdList, 0, 5, Me.ViewState("EmptyTable"))
        End If
        Me.grdList.RowStyle.Height = 18
        ...
        'tmpsql = "EXEC MMS_R02_" + Me.RadioButtonList1.SelectedValue + " "
