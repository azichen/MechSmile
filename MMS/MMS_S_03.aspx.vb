...
Partial Class MMS_MMS_S_03
    ...
    Protected Sub Page_Load(sender As Object, e As System.EventArgs) Handles Me.Load
        If Not IsPostBack Then
            ...
            modDB.SetFields("小計", "小計", grdList, HorizontalAlign.Left, "", False)
            ...
            If Session("QryField") Is Nothing Then
                Call modDB.ShowEmptyDataGridHeader(Me.grdList, 0, 27, Me.ViewState("EmptyTable"))
            Else
                'Call ReflashQryData()
            End If
            txtDtFrom1.Focus()
        ...
        '設定只可輸入數字
        Me.txtDtFrom5.Attributes.Add("onkeypress", "return CheckKeyNumber()")
    ...
    Protected Sub ExcelButton_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles ExcelButton.Click
        ...
        grdList.DataBind()
        modUtil.GridView2Excel("MMS_S_03.xls", Me.grdList)
    ...
    Private Sub ShowGrid()
        ...
        If tmpstr = "" Then
            ...
            Exit Sub
        End If
        If Me.txtDtFrom5.Text.Trim = "" Then
            modUtil.showMsg(Me.Page, "訊息", "請修正下列異常： \n" & "您未輸入年度!!")
            Exit Sub
        End If
        Dim tmpsql As String
        'EXEC MMS_S03 年度,客戶代號(起),客戶代號(迄),業務員
        'tmpsql = "EXEC MMS_S03 '2013','','',''"
        tmpsql = "EXEC MMS_S03 "
        If Me.txtDtFrom5.Text <> "" Then '年度
            tmpsql += "'" + Me.txtDtFrom5.Text + "',"
        Else
            tmpsql += "'',"
        End If
