'******************************************************************************************************
'* 程式：ATT_M_054 排班代碼資料維護
'* 版次：2013/06/04(VER1.01)：新開發
'******************************************************************************************************
Imports modUnset

Partial Class ATT_M_054
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        If Not IsPostBack Then
            ...
            If Request("formMode") = "add" Then '* 是否有新增權限
                ...
                Me.lblTitle.Text = "排班代號維護 - 新增表單"
            Else
                Me.fmvEdit.ChangeMode(FormViewMode.ReadOnly)
                Me.lblTitle.Text = "排班代號維護 - 瀏覽表單"
            End If
        End If
    ...
    Protected Sub fmvEdit_DataBound(ByVal sender As Object, ByVal e As System.EventArgs) Handles fmvEdit.DataBound
        ...
        If Me.fmvEdit.FindControl("ATT_M_054U") IsNot Nothing Then
            CType(Me.fmvEdit.FindControl("ATT_M_054U"), ATT_M_054U).InitScreen(fmvEdit.CurrentMode)
    ...
    Protected Sub dscMain_Updating(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.SqlDataSourceCommandEventArgs) _
        ...
        CType(Me.fmvEdit.FindControl("ATT_M_054U"), ATT_M_054U).UpdateDB(fmvEdit.CurrentMode, e) '* 主檔資料填入處理 
    End Sub
    ...
    Private Sub DBUpdated(ByVal pMode As String, ByVal e As Object)
        ...
        If Not cUpDateOK Then
            ...
            If e.Exception IsNot Nothing Then
                ...
                Else
                    'modDB.InsertSignRecord("AziTest", "ok-E", My.User.Name)
        ...
        '-----------------------------* 更新成功時，紀錄Log
        With fmvEdit.FindControl("ATT_M_054U")
            Me.lblMsg.Text = "資料" & pMode & "成功！"
            If pMode = "新增" Then
                Session("QryField") = Me.ViewState("QryField")
                Response.Redirect("ATT_Q_054.aspx?msg=" & Me.lblMsg.Text)
