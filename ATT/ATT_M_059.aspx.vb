'******************************************************************************************************
'* 程式：ATT_M_059 考勤雙週週期資料維護
'* 作成：
'* 版次：2015/07/01(VER1.01)：新開發
'******************************************************************************************************
Imports modUnset

Partial Class ATT_M_059
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        If Not IsPostBack Then
            ...
            If Request("formMode") = "add" Then '* 是否有新增權限
                ...
                Me.lblTitle.Text = "雙週週期設定資料 - 新增表單"
            Else
                Me.fmvEdit.ChangeMode(FormViewMode.ReadOnly)
                Me.lblTitle.Text = "雙週週期設定資料 - 瀏覽資料表單"
            End If
        End If
    ...
    Protected Sub fmvEdit_DataBound(ByVal sender As Object, ByVal e As System.EventArgs) Handles fmvEdit.DataBound
        ...
        If Me.fmvEdit.FindControl("ATT_M_059U") IsNot Nothing Then
            CType(Me.fmvEdit.FindControl("ATT_M_059U"), ATT_M_059U).InitScreen(fmvEdit.CurrentMode)
    ...
    Protected Sub btnFunc_Click(ByVal sender As Object, ByVal e As System.EventArgs)
        Select Case sender.ID
            ...
            Case "btnClear"
                Session("QryField") = Me.ViewState("QryField")
                Response.Redirect("ATT_M_059.aspx?FormMode=add")
            Case "btnDel"
    ...
    Protected Sub dscMain_Updating(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.SqlDataSourceCommandEventArgs) _
        ...
        CType(Me.fmvEdit.FindControl("ATT_M_059U"), ATT_M_059U).UpdateDB(fmvEdit.CurrentMode, e) '* 主檔資料填入處理 
    End Sub
    ...
    Private Sub DBUpdated(ByVal pMode As String, ByVal e As Object)
        ...
        '-----------------------------* 更新成功時，紀錄Log
        With fmvEdit.FindControl("ATT_M_059U")
            Me.lblMsg.Text = "資料" & pMode & "成功！"
            If pMode = "新增" Then
                Session("QryField") = Me.ViewState("QryField")
                Response.Redirect("ATT_Q_059.aspx?msg=" & Me.lblMsg.Text)
            ElseIf pMode = "修改" Then
                Session("QryField") = Me.ViewState("QryField")
                Response.Redirect("ATT_Q_059.aspx?msg=" & Me.lblMsg.Text)
