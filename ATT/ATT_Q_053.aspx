<%@ Page Language="VB" DEBUG="false" AutoEventWireup="false" CodeFile="ATT_Q_053.aspx.vb" Inherits="ATT_Q_053" Theme="ThemeCHG" %>
      ...
      <uc:UpdatePanelFix ID="updQry" runat="server" RenderMode="Inline" UpdateMode="Conditional">
         <ContentTemplate>
            <table class="table">
               <tr align="center">
                  <td colspan="2">
                     <asp:Label ID="lblTitle" runat="server" CssClass="titles" Text="打卡資料查詢" ></asp:Label></td>
               </tr>
               ...
               <tr>
                  ...
                  <td>
                     <asp:DropDownList ID="ddlBus" runat="server" AppendDataBoundItems="true" AutoPostBack="true"
                          DataSourceID="dscBus" DataTextField="Bus_Desc" DataValueField="Bus_ID" OnSelectedIndexChanged="ddlBus_SelectedIndexChanged" >
            　　　        <asp:ListItem Text="" />
              　　   </asp:DropDownList>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
             責任區：<asp:DropDownList ID="ddlArea" runat="server" AppendDataBoundItems="true"
                          DataSourceID="dscArea" DataTextField="Are_Desc" DataValueField="Are_ID" OnSelectedIndexChanged="ddlBus_SelectedIndexChanged" >
            　 　         <asp:ListItem Text="" />
                     </asp:DropDownList></td>
               </tr>
               ...
               <tr>
                ...
                <tr>
                  <td align="right" style="height:25px;"><span class="MustInput" >*</span>打卡日期：</td>
                  <td>
              ...
              <asp:TextBox ID="txtEmpID" runat="server" Width="80px" MaxLength="8" AutoPostBack="True" OnTextChanged="txtEmpID_TextChanged" /><asp:TextBox 
               ...
               <tr>
                 ...
                 <td><asp:RadioButtonList ID="rdoType" runat="server" RepeatColumns="2" RepeatDirection="Horizontal" RepeatLayout="Flow" >
                          ...
                          <asp:ListItem Value="2">打卡時間</asp:ListItem>
            ...
            <table class="table">
               <tr>
                  ...
                  <td style="width:85%">
                   ...
                   /><asp:LinkButton ID="btnNew" runat="server" Text="補登打卡資料" style="font-size:medium" />
                  </td>
               </tr>
               <tr>
