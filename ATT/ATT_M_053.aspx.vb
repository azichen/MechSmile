...
Partial Class ATT_M_053
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        If Not IsPostBack Then
            ...
            If Request("formMode") = "add" Then '* 是否有新增權限
                ...
                Me.lblTitle.Text = "打卡補登資料 - 新增表單"
            ElseIf Request("formMode") = "edit" Then '* 是否有新增權限
                If ViewState("ROL").Substring(1, 1) = "N" Then FormsAuthentication.RedirectToLoginPage()
                Me.fmvEdit.ChangeMode(FormViewMode.Edit)
                Me.lblTitle.Text = "打卡資料 - 瀏覽處理表單"
            Else
                Me.fmvEdit.ChangeMode(FormViewMode.ReadOnly)
                Me.lblTitle.Text = "打卡資料 - 瀏覽補登資料表單"
            End If
        End If
    ...
    Protected Sub fmvEdit_DataBound(ByVal sender As Object, ByVal e As System.EventArgs) Handles fmvEdit.DataBound
        ...
        If Me.fmvEdit.FindControl("ATT_M_053U") IsNot Nothing Then
            CType(Me.fmvEdit.FindControl("ATT_M_053U"), ATT_M_053U).InitScreen(fmvEdit.CurrentMode)
            ...
            If Me.fmvEdit.CurrentMode = FormViewMode.ReadOnly Then
                ...
                Dim FINDATE As String = Session("FINDATE").ToString
                If FINDATE <= LCKDT Then
                    Me.lblMsg.Text = "資料月份已鎖或過帳，不可異動!"
                    If Request("formMode") = "edit" Then
    ...
    Protected Sub btnFunc_Click(ByVal sender As Object, ByVal e As System.EventArgs)
        Select Case sender.ID
            ...
            Case "btnClear"
                Session("QryField") = Me.ViewState("QryField")
                Response.Redirect("ATT_M_053.aspx?FormMode=add")
            Case "btnDel"
    ...
    Protected Sub dscMain_Updating(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.SqlDataSourceCommandEventArgs) _
        ...
        CType(Me.fmvEdit.FindControl("ATT_M_053U"), ATT_M_053U).UpdateDB(fmvEdit.CurrentMode, e) '* 主檔資料填入處理 
    End Sub
    ...
    Protected Sub fmvEdit_ItemUpdated(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.FormViewUpdatedEventArgs) Handles fmvEdit.ItemUpdated
        'modDB.InsertSignRecord("AziTest", "修改", My.User.Name)
        Call DBUpdated("修改", e)
    End Sub
    ...
    Private Sub DBUpdated(ByVal pMode As String, ByVal e As Object)
        '-----------------* 執行 DB 更新
        'cUpDateOK = CType(Me.fmvEdit.FindControl("ATT_M_053U"), ATT_M_051U).UpdateDB(fmvEdit.CurrentMode, e)
        'modDB.InsertSignRecord("AziTest", "ok-a", My.User.Name)
        ...
        '-----------------------------* 更新成功時，紀錄Log
        With fmvEdit.FindControl("ATT_M_053U")
            Me.lblMsg.Text = "資料" & pMode & "成功！"
            If pMode = "新增" Then
                Session("QryField") = Me.ViewState("QryField")
                Response.Redirect("ATT_Q_053.aspx?msg=" & Me.lblMsg.Text)
