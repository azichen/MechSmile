<%@ Page Language="VB" DEBUG="false" AutoEventWireup="false" CodeFile="ATT_Q_061.aspx.vb" Inherits="ATT_Q_061" Theme="ThemeCHG" %>
      ...
      <uc:UpdatePanelFix ID="updQry" runat="server" RenderMode="Inline" UpdateMode="Conditional">
         <ContentTemplate>
            <table class="table">
               <tr align="center">
                  <td colspan="2">
                     <asp:Label ID="lblTitle" runat="server" CssClass="titles" Text="颱風假設定查詢" ></asp:Label></td>
               </tr>
               <tr style="height:5px">
