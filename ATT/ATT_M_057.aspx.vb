...
Partial Class ATT_M_057
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        If Not IsPostBack Then
            ...
            If Request("formMode") = "add" Then '* 是否有新增權限
                ...
                Me.lblTitle.Text = "表單申請 - 新增表單"
            Else
                Me.fmvEdit.ChangeMode(FormViewMode.ReadOnly)
                Me.lblTitle.Text = "表單申請 - 瀏覽表單"
            End If
        End If
    ...
    Protected Sub fmvEdit_DataBound(ByVal sender As Object, ByVal e As System.EventArgs) Handles fmvEdit.DataBound
        ...
        If Me.fmvEdit.FindControl("ATT_M_057U") IsNot Nothing Then
            CType(Me.fmvEdit.FindControl("ATT_M_057U"), ATT_M_057U).InitScreen(fmvEdit.CurrentMode)
    ...
    Protected Sub dscMain_Updating(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.SqlDataSourceCommandEventArgs) _
        ...
        CType(Me.fmvEdit.FindControl("ATT_M_057U"), ATT_M_057U).UpdateDB(fmvEdit.CurrentMode, e) '* 主檔資料填入處理 
    ...
    Private Sub DBUpdated(ByVal pMode As String, ByVal e As Object)
        ...
        '-----------------------------* 更新成功時，紀錄Log
        With fmvEdit.FindControl("ATT_M_057U")
            Me.lblMsg.Text = "資料" & pMode & "成功！"
            'If pMode = "新增" Then
            Session("QryField") = Me.ViewState("QryField")
            Response.Redirect("ATT_Q_057.aspx?msg=" & Me.lblMsg.Text)
            'End If
        End With
    End Sub
