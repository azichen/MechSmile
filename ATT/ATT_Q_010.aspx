<%@ Page Language="C#" debug="false" AutoEventWireup="true" CodeFile="~/ATT/ATT_Q_010.aspx.cs" Inherits="ATT_Q_010" EnableEventValidation = "false" Theme="ThemeCHG" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head runat="server">
   <title>出勤異常檢核_工時統計表</title>
            ...
            <table class="table">
               <tr>
                  <td align="center" style="height:12px" colspan="2">
                     <asp:Label ID="lblTitle" runat="server" CssClass="titles" Text="出勤異常檢核_工時統計表" /></td>
               </tr>
               <tr>
            ...
            　 　         <asp:ListItem Text="" />
               ...
               <tr>
                ...
                <td style="height: 25px" colspan="4">
                  ...
                  <img src="../Images/date.gif" alt="按此可點選日期" style="border:0;" onclick="ShowCalendar('txtDtStart',true,true)" />
                  &nbsp 至 &nbsp<asp:TextBox ID="txtDtTo" runat="server" Width="60px" MaxLength="7" />
                     <img src="../Images/date.gif" alt="按此可點選日期" style="border:0;"  onclick="ShowCalendar('txtDtTo',true,true)" />
                 </td>     
               </tr>
            </table>
         </ContentTemplate>
