<%@ Page Language="VB" DEBUG="false" AutoEventWireup="false" CodeFile="ATT_Q_057.aspx.vb" Inherits="ATT_Q_057" Theme="ThemeCHG" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head runat="server">
   <title>人事表單申請資料查詢</title>
      ...
      <uc:UpdatePanelFix ID="updQry" runat="server" RenderMode="Inline" UpdateMode="Conditional">
         <ContentTemplate>
            <table class="table">
               <tr align="center">
                  <td colspan="2">
                     <asp:Label ID="lblTitle" runat="server" CssClass="titles" Text="人事表單申請資料查詢" ></asp:Label></td>
               </tr>
               <tr style="height:5px">
               ...
               <tr>
                ...
                <tr>
                  <td align="right" style="height:25px;"><span class="MustInput" >*</span>申請日期：</td>
                  <td>
            ...
            <table class="table">
               <tr>
                  ...
                  <td style="width:85%">
                   ...
                   />  <asp:LinkButton ID="btnNew" runat="server" Text="新增資料" style="font-size:medium" />
                  </td>
               </tr>
               <tr>
               ...
               <tr>
                  ...
                  <asp:Label ID="Label1" runat="server" CssClass="msg" Text="您提供的個人資料，本公司將依個人資料保護法之規定搜集、處理、利用、保存您所提供之基本資料，及恪遵相關法令之保密原則。站長亦請務必要盡系統監督及管理之責任。" ></asp:Label></td>
               </tr>
