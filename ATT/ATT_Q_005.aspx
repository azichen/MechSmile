<%@ Page Language="C#" debug="false" AutoEventWireup="true" CodeFile="~/ATT/ATT_Q_005.aspx.cs" Inherits="ATT_Q_005" EnableEventValidation = "false" Theme="ThemeCHG" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head runat="server">
   <title>出勤時數統計查詢</title>
   ...
   <form id="form1" runat="server">     
            ...
            <table class="table">
               <tr>
                  <td align="center" style="height:12px" colspan="2">
                     <asp:Label ID="lblTitle" runat="server" CssClass="titles" Text="出勤時數統計查詢" /></td>
               </tr>
               <tr>
            ...
            　 　         <asp:ListItem Text="" />
               ...
               <tr>
                  ...
                  <td>
                   ...
                   /> <asp:TextBox ID="txtEmpName" runat="server" Width="150px" />
                     <asp:Button ID="btnEmpID" runat="server" Text="選擇員工" style="width:80px" OnClick="btnEmpID_Click" /> </td>
               </tr>
               ...
               <tr>
                 ...
                 <td><asp:RadioButtonList ID="rdoType" runat="server" RepeatColumns="2" RepeatDirection="Horizontal" RepeatLayout="Flow" >
                          <asp:ListItem Value="1" Selected="True">明細表</asp:ListItem>
      ...
      <asp:UpdatePanel ID="udpGrid" runat="server" RenderMode="Inline" UpdateMode="Conditional">
         <ContentTemplate>
            ...
            <asp:GridView ID="grdList" runat="server" DataSourceID="DSCLIST" OnRowDataBound="grdList_RowDataBound" OnDataBound="grdList_DataBound" OnPageIndexChanged="grdList_PageIndexChanged" OnSelectedIndexChanged="grdList_SelectedIndexChanged" />
         </ContentTemplate>
      </asp:UpdatePanel>
   </form>
</body>
