...
partial class ATT_Q_017 : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!(Page.IsPostBack))
        {
            ...
            if (User.Identity.IsAuthenticated)
            {
                ...
                modDB.SetFields("STNID", "單位編號", this.grdList, HorizontalAlign.Center, "", false, 0, false);
                modDB.SetFields("ARENAME", "區域", this.grdList, HorizontalAlign.Center, "", false, 0, false);
                modDB.SetFields("STNNAME", "單位名稱", this.grdList, HorizontalAlign.Center, "", false, 0, false);
                ...
                modDB.SetFields("FACWH1", "實際工時", this.grdList, HorizontalAlign.Center, "", false, 0, false);
                modDB.SetFields("DAYOVER1", "單日超時", this.grdList, HorizontalAlign.Center, "", false, 0, false);
                modDB.SetFields("TWKOVER1", "雙周超時", this.grdList, HorizontalAlign.Center, "", false, 0, false);
    ...
    protected void  ShowGrid()
    {
        ...
        {
            //modUtil.showMsg(this.Page, "訊息", txtDtFrom.Text + "查無週期區間！");
            lblMsg.Text = txtDtFrom.Text + "查無週期區間！" + Convert.ToString(sSQL.Length) + " " + sSQL;
        }
