<%@ Page Language="C#" debug="false" AutoEventWireup="true" CodeFile="~/ATT/ATT_Q_004.aspx.cs" Inherits="ATT_Q_004" EnableEventValidation = "false" Theme="ThemeCHG" %>
      ...
      <asp:UpdatePanel ID="udpQry" runat="server" RenderMode="Inline" UpdateMode="Conditional">
         <ContentTemplate>
            <table class="table">
               <tr>
                  <td align="center" style="height:12px" colspan="2">
                     <asp:Label ID="lblTitle" runat="server" CssClass="titles" Text="請假狀況查詢" /></td>
               </tr>
               <tr>
            ...
            　 　         <asp:ListItem Text="" />
               ...
               <tr>
                  <td align="right" style="height: 25px; width: 120px;"><span class="MustInput" >*</span>年　　度：</td>
                <td style="height: 25px" >
                  <asp:TextBox ID="txtDtStart" runat="server" Width="60px" MaxLength="4" cssclass="readonlyDate"></asp:TextBox>
                  (限制查詢目前在職員工)
               </tr>
