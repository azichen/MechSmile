<%@ Page Language="C#" debug="false" AutoEventWireup="true" CodeFile="~/ATT/ATT_Q_008.aspx.cs" Inherits="ATT_Q_008" EnableEventValidation = "false" Theme="ThemeCHG" %>
      ...
      <asp:UpdatePanel ID="udpQry" runat="server" RenderMode="Inline" UpdateMode="Conditional">
         <ContentTemplate>
            <table class="table">
               <tr>
                  <td align="center" style="height:12px" colspan="2">
                     <asp:Label ID="lblTitle" runat="server" CssClass="titles" Text="請假異常查詢" /></td>
               </tr>
               <tr>
            ...
            　 　         <asp:ListItem Text="" />
               ...
               <tr>
                  <td align="center" style="height:12px" colspan="2">
                     <asp:Label ID="Label1" runat="server" Text="本表顯示資料僅篩掉合乎排班資料的資料，顯示資料並不代表必為異常資料，請綜合各欄位資料再作判斷。" ForeColor="Red" /></td>
               </tr>
            </table>
         </ContentTemplate>
      </asp:UpdatePanel>
